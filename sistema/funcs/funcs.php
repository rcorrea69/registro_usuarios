<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'smtp.hostinger.com'; //Modificar
		$mail->Port = 465; //Modificar
		
		$mail->Username = 'rcorrea@mpcargentina.net'; //Modificar
		$mail->Password = '@Rc0rr34'; //Modificar
		
		$mail->setFrom('rcorrea@mpcargentina.net', 'TUC Prode'); //Modificar
